...
public class Speaker extends AudioDevice implements Wing{
	...
	public void setVolume(){ //브레이스가 존재하기만 해도, 재정의를 완성한것임, 구현강제
